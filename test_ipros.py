...
url = "https://mono.ipros.com/en/cg2/IoT%20devices/"
...
try:
    ...
    with open('ipros_response.json', 'w', encoding='utf-8') as f:
        json.dump(res_json, f)

    if "data" in res_json and "markdown" in res_json["data"]:
        with open('ipros_markdown.txt', 'w', encoding='utf-8') as f:
            f.write(res_json["data"]["markdown"])
        print("Markdown saved to ipros_markdown.txt")
    else:
